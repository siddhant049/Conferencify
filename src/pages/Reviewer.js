    ...
    <>
        <div className="adminContainer">
            ...
            <div className='contentsAdmin'>
                ...
                <div className='roleHeading' ><h3>Role: Reviewer</h3></div>
            </div>
            <div>
                <Box component="form" onSubmit={handleSubmit} sx={{ width: '100%' }} style={{marginTop:"50px",marginLeft:"20px"}}>
                            ...
                            <div style={{marginRight:"70px",marginLeft:"30px"}}>
                                <Accordion expanded={expanded === 'panel1'} onChange={handleChangeaccordition('panel1')}>
                                        ...
                                        <FormControl sx={{marginLeft:'200px'}}>
                                              ...
                                              <Button variant="contained" style={{marginLeft:'100px',maxHeight:'28px'}}  onClick={() => { 
                                                                                                              console.log('clicked');        
                                                                                                            }} >Download  </Button>
                                                ...
                                                Review the Paper<br/>
                                                  ...
                                                  <Grid container spacing={1}>  
                                                      <Grid item xs={12} style={{paddingTop:"20px"}}> 
                                                        <InputLabel id="demo-simple-select-label"   ><i>What is Your Overall Evaluation of the Paper *</i></InputLabel>
                                                        <RadioGroup
                                                      ...
                                                      <Grid item xs={12} style={{paddingTop:"20px"}}> 
                                                        <InputLabel id="demo-simple-select-label"   ><i>Your Knowledge about the Subject Well Aware *</i></InputLabel>
                                                        <RadioGroup
                                                          aria-labelledby="demo-radio-buttons-group-label"
                                                          defaultValue="female"
                                                          name="awareness"
                                                                >
                                                          <FormControlLabel value="aware" control={<Radio />} label="Aware" />
                                                          <FormControlLabel value="moderatelyunaware" control={<Radio />} label="Moderately Aware" />
                                                          <FormControlLabel value="unaware" control={<Radio />} label="Unaware" />
                                                      ...
                                                      <Grid item xs={12} style={{paddingTop:"20px"}}> 
                                                        <InputLabel id="demo-simple-select-label"   ><i>Authenticity of The Work  *</i></InputLabel>
                                                        <Box
                                                            sx={{
                                                              width: 200,
                                                              display: 'flex',
                                                          ...
                                                          >
                                                            ...
                                                            />
                                                            {valuenew !== null && (
                                                              <Box sx={{ ml: 2 }}>{labels[hover !== -1 ? hover : valuenew]}</Box>
                                                            )}
                                                          </Box>
                                                      </Grid>
                                                      ...
                                                      <Grid item xs={12} style={{paddingTop:"20px"}}> 
                                                        <InputLabel id="demo-simple-select-label"   ><i>Methodological rigor of the paper(question change krna hai) *</i></InputLabel>
                                                        <Box
                                                            sx={{
                                                              width: 200,
                                                              display: 'flex',
                                                          ...
                                                          >
                                                            ...
                                                            />
                                                            {valuenew2 !== null && (
                                                              <Box sx={{ ml: 2 }}>{labels[hover2 !== -1 ? hover2 : valuenew2]}</Box>
                                                            )}
                                                          </Box>
                                                      </Grid>
                                                      ...
                                                      <Grid item xs={12} style={{paddingTop:"20px"}}> 
                                                        <InputLabel id="demo-simple-select-label"   ><i>Aptness of The Work *</i></InputLabel>
                                                        <Box
                                                            sx={{
                                                              width: 200,
                                                              display: 'flex',
                                                          ...
                                                          >
                                                            ...
                                                            />
                                                            {valuenew3 !== null && (
                                                              <Box sx={{ ml: 2 }}>{labels[hover3 !== -1 ? hover3 : valuenew3]}</Box>
                                                            )}
                                                          </Box>
                                                      </Grid>
                                                      ...
                                                      <Grid item xs={12} style={{paddingTop:"20px"}}> 
                                                        <InputLabel id="demo-simple-select-label"   ><i>Grammatical Accuracy and Content Clarity *</i></InputLabel>
                                                        <Box
                                                            sx={{
                                                              width: 200,
                                                              display: 'flex',
                                                          ...
                                                          >
                                                            ...
                                                            />
                                                            {valuenew4 !== null && (
                                                              <Box sx={{ ml: 2 }}>{labels[hover4 !== -1 ? hover4 : valuenew4]}</Box>
                                                            )}
                                                          </Box>
                                                      </Grid>
                                                      ...
                                                      <Grid item xs={12} style={{paddingTop:"20px"}}> 
                                                        <InputLabel id="demo-simple-select-label"   ><i>Value added to the existing Works in the Field *</i></InputLabel>
                                                        <Box
                                                            sx={{
                                                              width: 200,
                                                              display: 'flex',
                                                          ...
                                                          >
                                                            ...
                                                            />
                                                            {valuenew5 !== null && (
                                                              <Box sx={{ ml: 2 }}>{labels[hover5 !== -1 ? hover5 : valuenew5]}</Box>
                                                            )}
                                                          </Box>
                                                      </Grid>
                                                      ...
                                                      <Grid item xs={12} style={{paddingTop:"20px"}}> 
                                                        <InputLabel id="demo-simple-select-label"   ><i>Quality of the elements inside the paper . i.e Tables , Figures and Content *</i></InputLabel>
                                                        <Box
                                                            sx={{
                                                              width: 200,
                                                              display: 'flex',
                                                          ...
                                                          >
                                                            ...
                                                            />
                                                            {valuenew6 !== null && (
                                                              <Box sx={{ ml: 2 }}>{labels[hover6 !== -1 ? hover6 : valuenew6]}</Box>
                                                            )}
                                                          </Box>
                                                      </Grid>
                                                      ...
                                                      <TextField variant="outlined"  multiline rows={4} name='comments'
                                                      maxRows={10} placeholder="Comments*" fullWidth required ></TextField>
                                                      </Grid>


                                                      <Button type= "submit" variant="contained" style={{marginLeft:'30px'}}>Done </Button>
